                                ...
                                <div class="card z-index-0 fadeIn3 fadeInBottom">
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div class="bg-gradient-warning shadow-warning border-radius-lg py-3 pe-1">
                                            <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Registrazione atleti!</h4>
                                            <div class="row mt-3">
                                    ...
                                    <div class="card-body">
                                        <form autocomplete="off" method="POST" class="text-start">
                                            ...
                                            <input type="hidden" id="user" name="user" value="signup" />
                                            ...
                                            <div class="row justify-content-center">
                                                <a href="./SignupAllenatore" class="btn btn-link text-dark">
                                                        Sei un nuovo allenatore ? Registrati !
                                                </a>
                                            </div>
                                        </form>
                                    </div>
